    ...
    public partial class SalesRep_List : System.Web.UI.Page
    {
        ...
        private void FillSMControls(int SmId)
        {
            try
            {
                ...
                string Smquery = @"select *,isnull(AllowChangeCity,0)as AllowChangeCity1,isnull(MobileAccess,0)as MobileAccess1,isnull(Managerapp,0)as Managerapp1,isnull(DMTApp,0)as DMTApp1 from MastSalesRep msr left join MastLogin Ml On Msr.UserId=Ml.id where SMId=" + SmId;
