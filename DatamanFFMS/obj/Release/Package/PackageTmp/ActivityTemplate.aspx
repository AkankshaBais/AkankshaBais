    ...
    <script type="text/javascript">
        ...
        function CreateOptionsVal() {
            ...
            if (type == "Dropdown" || type == "Checkbox") {
                var li = $("<div class='col-md-12 col-sm-12 col-xs-12' id='ddoptioncontainer'>");
        ...
        function CreateControlValues(ControlName) {
            return '<div class="form-group" id="ele0"><label>Add ' + ControlName + '  Values </label> </div> <div class="form-group" id="ele1"><div class="row"><div class="col-lg-10 col-md-10 col-sm-10 col-xs-12"><input type="text" maxlength="20" id="txtaddval1" class="form-control"/></div><div class="col-lg-2 col-md-2 col-sm-2 col-xs-12"> <a id="a1" onclick="addOption(1)"><label class="col-dm-1 control-label"><i class="fa fa-plus"></i></label></a></div></div>'
        }
        function addOption(ind) {
            var id = $("#ddoptioncontainer > div").length;
            var html = '<div class="form-group" id="ele' + id + '"> <div class="row"><div class="col-lg-10 col-md-10 col-sm-10 col-xs-12"><input type="text" maxlength="20" id="txtaddval' + id + '" class="form-control"/></div><div class="col-lg-2 col-md-2 col-sm-2 col-xs-12"><a  onclick="CloseOption(' + id + ')"><label class="col-dm-1 control-label"><i class="fa fa-minus-circle"></i></label></a> &nbsp;&nbsp;<a id="a' + id + '" onclick="addOption(' + id + ')"><label class="col-dm-1 control-label"><i class="fa fa-plus"></i></label></a></div></div>';
            $("#a" + ind).hide();
            $("#ele" + ind).after(html);
        }
        ...
        function editrow(rowdata) {
            ...
            if (type == "Dropdown" || type == "Checkbox") {
                ...
                var data = $(rowdata).parent().parent().children("td:nth-child(4)").html().split('*');
                var html = "<div class='col-md-12 col-sm-12 col-xs-12' id='ddoptioncontainer'><div class='form-group' id='ele0'><label>Add " + type + "  Values </label> </div>";
                for (var j = 0; j < data.length; j++) {
                    var id = $("#ddoptioncontainer > div").length;
                    if (data.length == 1) {

                        html += "<div class='form-group' id='ele" + id + "'><div class='row'><div class='col-lg-10 col-md-10 col-xs-12'><input type='text' maxlength='20' id='txtaddval" + id + "' class='form-control' value=" + data[j] + " " + disable + "></div>";
                        html += "<div class='col-lg-2 col-md-2 col-xs-12'> <a id='a1' onclick='addOption(" + id + ")' ><label class='col-dm-1 control-label'><i class='fa fa-plus'></i></label></a></div></div></div>";
                    }
                    else {
                        if (j == 0) {
                            html += "<div class='form-group' id='ele" + id + "'><div class='row'><div class='col-lg-10 col-md-10 col-xs-12'><input type='text' maxlength='20' id='txtaddval" + id + "' class='form-control' value=" + data[j] + " " + disable + "></div>";
                            html += "<div class='col-lg-2 col-md-2 col-xs-12'> <a id='a1' onclick='addOption(" + id + ")' style='display:none;' ><label class='col-dm-1 control-label'><i class='fa fa-plus'></i></label></a></div></div></div>";

                        }
                        else {
                            html += "<div class='form-group' id='ele" + id + "'> <div class='row'><div class='col-lg-10 col-md-10 col-xs-12'><input type='text' maxlength='20' id='txtaddval" + id + "' class='form-control' value=" + data[j] + " " + disable + "></div>";
                            html += "<div class='col-lg-2 col-md-2 col-xs-12'><a onclick='CloseOption(" + id + ")'><label class='col-dm-1 control-label'><i class='fa fa-minus-circle'></i></label></a> &nbsp;&nbsp;<a id='a2' onclick='addOption(" + id + ")'><label class='col-dm-1 control-label'><i class='fa fa-plus'></i></label></a></div></div></div>";
                        }
                    }
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input id="dyntitle" class="form-control" placeholder="Enter Title" name="dynfname" type="text" maxlength="20" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type='text' id="FromDate" class="form-control datepicker" maxlength="20" readonly="readonly" autocomplete="off"/>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type='text' id="ToDate" class="form-control datepicker" maxlength="20" readonly="readonly" onchange="compare();" autocomplete="off" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input id="dynfname" class="form-control" placeholder="Enter Field Name" name="dynfname" type="text" maxlength="20" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Sorting Order:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                        <input id="dynsort" class="form-control numeric text-left" placeholder="Enter Sorting Order" name="dynsort" type="number" min="0" max="9" maxlength="5" autocomplete="off">
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input id="chkIsActive" type="checkbox" checked="checked" class="checkbox" >
                                    </div>
                                </div>
