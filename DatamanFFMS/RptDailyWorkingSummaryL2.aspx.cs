...
namespace AstralFFMS
{
    public partial class RptDailyWorkingSummaryL2 : System.Web.UI.Page
    {
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            string headertxt = "Visit Date".TrimStart('"').TrimEnd('"') + "," + "Sales Person".TrimStart('"').TrimEnd('"') + "," + "Type".TrimStart('"').TrimEnd('"') + "," + "Remarks".TrimStart('"').TrimEnd('"') + "," + "City".TrimStart('"').TrimEnd('"') + "," + "Beat".TrimStart('"').TrimEnd('"') + "," + "Total Retailer".TrimStart('"').TrimEnd('"') + "," + "Retailer Visited".TrimStart('"').TrimEnd('"') + "," + "Retailer Productive Calls".TrimStart('"').TrimEnd('"') + "," + "Total Order".TrimStart('"').TrimEnd('"') + "," + "Demo".TrimStart('"').TrimEnd('"') + "," + "Non-Productive".TrimStart('"').TrimEnd('"') + "," + "Competitor".TrimStart('"').TrimEnd('"') + "," + "Retai. Discuss".TrimStart('"').TrimEnd('"') + "," + "Retailer Collection".TrimStart('"').TrimEnd('"') + "," + "New Retailer".TrimStart('"').TrimEnd('"') + "," + "Retailer Per Call Avg Sale".TrimStart('"').TrimEnd('"') + "," + "Claim Exp.".TrimStart('"').TrimEnd('"') + "," + "Approved Exp.".TrimStart('"').TrimEnd('"') + "," + "Dist. Discuss".TrimStart('"').TrimEnd('"') + "," + "Dist. Non-Productive".TrimStart('"').TrimEnd('"') + "," + "Dist. Collection".TrimStart('"').TrimEnd('"') + "," + "Start DSR Time".TrimStart('"').TrimEnd('"') + "," + "First Call".TrimStart('"').TrimEnd('"') + "," + "Last Call".TrimStart('"').TrimEnd('"') + "," + "Status".TrimStart('"').TrimEnd('"') + "," + "DSR Type".TrimStart('"').TrimEnd('"') + "," + "Approved Remarks".TrimStart('"').TrimEnd('"') + "," + "With Whom".TrimStart('"').TrimEnd('"');
